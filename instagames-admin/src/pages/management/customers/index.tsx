...
import PageHeader from '@/content/Management/Users/AllList/PageHeader';
import RecentOrders from '@/content/Management/Users/AllList/RecentOrders';
...
function ApplicationsUsers() {
  return (
    <>
      <Head>
        <title>Instagame Admin | Users</title>
      </Head>
      <PageTitleWrapper>
        <PageHeader />
      </PageTitleWrapper>
