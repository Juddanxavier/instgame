        ...
        >
          <Paper elevation={9} sx={{ borderRadius: 1, overflow: 'hidden' }}>
            <a target='_blank' rel='noreferrer' href='/'>
              <img width='100%' alt='instagame-pro-banner' src='/images/logo.png' />
            </a>
            <CardContent>
              <Typography sx={{ mb: 4 }} variant='h6'>
                Insta Game - React Admin Template
              </Typography>
              <Typography sx={{ mb: 4 }} variant='body2'>
                Insta Game Admin is the most developer friendly & highly customizable Admin Dashboard Template based on
                MUI and NextJS.
              </Typography>
              <Typography sx={{ mb: 4 }} variant='body2'>
